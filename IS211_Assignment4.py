...
# The Function to generate random list
...
# Algorithm functions for searching the  lists
...
if __name__ == "__main__":
    ...
    # sequential search time variables
    total_oseq1 = 0
    total_oseq2 = 0
    total_oseq3 = 0

    # binary search time variables
    total_ibin1 = 0
    total_ibin2 = 0
    total_ibin3 = 0

    # recursive binary search time variables
    total_rbin1 = 0
    total_rbin2 = 0
    total_rbin3 = 0
    ...
    # Average time for each list size and search type and print
    ...
    print(
        f"Ordered Sequential Search took {avg_time_oseq1:10.7f} seconds to run, on average for a list of {size1} elements")
    print(
        f"Binary Search Iterative took {avg_time_ibin1:10.7f} seconds to run, on average for a list of {size1} elements")
    print(
        f"Binary Search Recursive took {avg_time_rbin1:10.7f} seconds to run, on average for a list of {size1} elements\n")

    print(f"Sequential Search took {avg_time_seq2:10.7f} seconds to run, on average for a list of {size2} elements")
    print(
        f"Ordered Sequential Search took {avg_time_oseq2:10.7f} seconds to run, on average for a list of {size2} elements")
    print(
        f"Binary Search Iterative took {avg_time_ibin2:10.7f} seconds to run, on average for a list of {size2} elements")
    print(
        f"Binary Search Recursive took {avg_time_rbin2:10.7f} seconds to run, on average for a list of {size2} elements\n")

    print(f"Sequential Search took {avg_time_seq3:10.7f} seconds to run, on average for a list of {size3} elements")
    print(
        f"Ordered Sequential Search took {avg_time_oseq3:10.7f} seconds to run, on average for a list of {size3} elements")
    print(
        f"Binary Search Iterative took {avg_time_ibin3:10.7f} seconds to run, on average for a list of {size3} elements")
    print(
        f"Binary Search Recursive took {avg_time_rbin3:10.7f} seconds to run, on average for a list of {size3} elements")